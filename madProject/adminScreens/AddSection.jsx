...
<View className="form space-y-2">
  ...
  <TextInput value={instructorName} onChangeText={(value)=>{setInstructorName(value)}}  style={{fontFamily:"Poppins-Bold"}} className="p-4 bg-gray-100 text-gray-700 rounded-2xl" placeholder="Enter Section Name"/>
  <Text className="text-gray-700 ml-4" style={{fontFamily:'Poppins-Bold'}}>
    Section Strength
  </Text>
  <TextInput  value={instructorNum} onChangeText={(value)=>{setInstructorNum(value)}}  style={{fontFamily:"Poppins-Bold"}} className="p-4 bg-gray-100 text-gray-700 rounded-2xl" placeholder="Enter Section strength"/>
  ...
  <TouchableOpacity onPress={()=>{
    ...
    <Text  style={{fontFamily:"Poppins-Bold"}} className=" text-2xl p-2 text-center text-gray-700">
      {loading ? <View className="flex flex-row justify-center items-center"><SmallButtonLoader/></View> : "Add Section"}
    </Text>
  </TouchableOpacity>
</View>
{listLoading ? <MedLoader/> : <FlatList
  ...
  renderItem={({item})=>(
    <View className="flex-row items-center justify-between border-2 border-black p-4 mt-2 bg-gray-100 rounded-2xl mb-2">
      <Text style={{fontFamily:"Poppins-Bold"}} className="text-gray-700">{item.SectionName}</Text>
      <Text style={{fontFamily:"Poppins-Bold"}} className="text-gray-700">{'Strength: '+item.SectionStrength}</Text>
    </View>
  )}
